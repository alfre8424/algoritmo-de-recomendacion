...
export default class SessionDatasource {
  ...
  async login(email: string, password: string): Promise<Either<AppError, UserEntity>> {
    ...
    // target url to login
    const url = `${Globals.TRANSACTIONAL_API}/auth/login`;
  ...
  async checkSession(): Promise<Either<AppError, UserEntity>> {
    ...
    // target url to login
    const url = `${Globals.TRANSACTIONAL_API}/auth/check`;
  ...
  async register(data: UserEntity): Promise<Either<AppError, boolean>> {
    // target url to login
    const url = `${Globals.TRANSACTIONAL_API}/auth/signup`;
  ...
  async logout(): Promise<Either<AppError, boolean>> {
    ...
    // target url to login
    const url = `${Globals.TRANSACTIONAL_API}/auth/logout`;
  ...
  async update(data: UserEntity): Promise<Either<AppError, boolean>> {
    // target url to login
    const url = `${Globals.TRANSACTIONAL_API}/auth/update`;
